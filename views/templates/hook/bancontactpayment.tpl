...
<p class="payment_module stripe_payment_button">
    <a id="stripe_bancontact_payment_link" href="{$link->getModuleLink('stripe', 'eupayment', ['method' => 'bancontact'], true)|escape:'htmlall':'UTF-8'}" title="{l s='Pay with Bancontact' mod='stripe'}">
