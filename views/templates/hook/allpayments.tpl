...
*}
{if (Configuration::get(Stripe::STRIPE_CHECKOUT) && in_array($stripeCurrency, Stripe::$methodCurrencies['credit_card']))}
...
{/if}
{if (Configuration::get(Stripe::IDEAL) && in_array($stripeCurrency, Stripe::$methodCurrencies['ideal']))}
...
{/if}
{if (Configuration::get(Stripe::BANCONTACT) && in_array($stripeCurrency, Stripe::$methodCurrencies['bancontact']))}
...
{/if}
{if (Configuration::get(Stripe::GIROPAY) && in_array($stripeCurrency, Stripe::$methodCurrencies['giropay']))}
...
{/if}
{if (Configuration::get(Stripe::SOFORT) && in_array(Tools::strtoupper($country->iso_code), ['AT', 'DE', 'NL', 'BE', 'ES'])  && in_array($stripeCurrency, Stripe::$methodCurrencies['sofort']))}
...
{/if}
{if (Configuration::get(Stripe::ALIPAY) && in_array($stripeCurrency, Stripe::$methodCurrencies['alipay']))}
...
{/if}
{if (Configuration::get(Stripe::STRIPE_CC_FORM) && in_array($stripeCurrency, Stripe::$methodCurrencies['credit_card']))}
...
{/if}
{if (Configuration::get(Stripe::STRIPE_APPLE_PAY) && in_array($stripeCurrency, Stripe::$methodCurrencies['credit_card']))}
