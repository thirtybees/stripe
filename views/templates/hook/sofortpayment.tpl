...
<p class="payment_module stripe_payment_button">
    <a id="stripe_sofort_payment_link" href="{$link->getModuleLink('stripe', 'eupayment', ['method' => 'sofort'], true)|escape:'htmlall':'UTF-8'}" title="{l s='Pay with Sofort Banking' mod='stripe'}">
