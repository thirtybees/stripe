    ...
    <div class="cell thirtybees thirtybees-stripe">
      <form>
        ...
        <div id="success-text" class="success" style="display: none">
          <div class="icon">
            <svg width="17" height="17" viewBox="0 0 84 84" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      function initElements() {
        ...
        function sendHeight() {
          top.postMessage(JSON.stringify({
            ...
            subject: 'height',
            height: document.querySelector('body').offsetHeight + 60,
          }), '*');
        }
