...
{if (isset($status) == true) && ($status == 'ok')}
  ...
  <p>
    ...
    <br/><br/>{l s='If you have questions, comments or concerns, please contact our' mod='stripe'} <a
            href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='stripe'}</a>
  </p>
{else}
  ...
  <p>
    ...
    <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='stripe'}</a>
  </p>
{/if}
<hr/>
